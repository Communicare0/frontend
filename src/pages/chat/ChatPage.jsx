...
export default function ChatPage() {
    ...
    useEffect(() => {
        ...
        const subscription = subscribeRoom(selectedRoomId, (chatMessage) => {
      ...
      <div className={s.mainWrapper}>
                ...
                <div className={s.groupFriendsList}>
                  ...
                  {friends.map((f) => {
                    ...
                    const name =
                      ...
                      f.addresseeNickname ||
                      "Friend";
                    const id = f.requesterId === f.addresseeId
                      ? f.requesterId
                      : f.requesterId; // 백 구조에 맞게 조정 필요하면 조정
        ...
        <main className={s.chatMain}>
          ...
          <section className={s.messagesArea}>
            ...
            {messages.map((m) => (
              <div key={m.chatMessageId} className={s.messageRow}>
